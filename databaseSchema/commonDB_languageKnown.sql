...
CREATE TABLE `languageKnown` (
  ...
  UNIQUE KEY `lid` (`lid`),
  KEY `sid` (`sid`),
  CONSTRAINT `languageKnown_ibfk_1` FOREIGN KEY (`sid`) REFERENCES `option_master` (`sid`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `languageKnown_ibfk_2` FOREIGN KEY (`canid`) REFERENCES `candidateMaster` (`canid`) ON DELETE CASCADE ON UPDATE CASCADE
